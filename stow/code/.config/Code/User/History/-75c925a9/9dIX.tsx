export default function Home() {
  ...
  return (
    <div className="justify-around flex-col items-stretch flex min-w-screen min-h-screen">

      {/* Header */}

      <div className="fixed w-full bg-gradient-to-br from-slate-900 via-orange-950 to-rose-900">
