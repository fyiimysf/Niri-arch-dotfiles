      ...
      <div className="fixed size-full bg-gradient-to-br from-slate-900 via-orange-950 to-rose-900">
        ...
        <main className="size-[92%] sm:size-108 mx-auto pt-20 sm:pt-0 " >
          <div className="relative group">
            ...
            {/* Video container */}
            <div className="fixed -inset-4 bg-gradient-to-r from-amber-600 via-orange-600 to-rose-600 rounded-2xl blur-xl opacity-20 group-hover:opacity-50 transition-opacity duration-500"></div>
