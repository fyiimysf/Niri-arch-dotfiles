export default function Home() {
  ...
  return (
    <div className="justify-center flex-col items-stretch flex w-screen h-screen bg-gradient-to-br from-slate-900 via-orange-950 to-rose-900">
      ...
      <div className="">
        ...
        {/* Footer */}
        <footer className="absolute w-full pb-5 bottom-0">
