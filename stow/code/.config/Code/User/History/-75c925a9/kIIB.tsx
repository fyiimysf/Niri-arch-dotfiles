export default function Home() {
  ...
  return (
    <div className="justify-around flex-col items-stretch flex w-screen h-screen">
      ...
      <div className="fixed -z-10 size-full bg-gradient-to-br from-slate-900 via-orange-950 to-rose-900 opacity-60">
        ...
        {/* Footer */}
        <footer className="bottom-0 absolute w-full pb-5">
