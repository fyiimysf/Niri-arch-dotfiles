      ...
      {/* <div className="absolute -z-10 h-full w-screen bg-gradient-to-br from-slate-900 via-orange-950 to-rose-900 opacity-60"></div> */}
        ...
        <main className="size-[92%] sm:size-108 mx-auto pt-50 sm:pt-0 " >
          <div className="relative group">
            ...
            <div className="absolute -inset-4 bg-gradient-to-r from-amber-600 via-orange-600 to-rose-600 rounded-2xl blur-xl opacity-20 group-focus:opacity-50 transition-opacity duration-500"></div>
            {/* Video container */}
